      ...
      <section className="relative overflow-hidden bg-gray-100">
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            >
              Better handling, even tire wear, safer braking. Our laser-guided
              alignment gets your car back to factory specs—and your ride back
              to smooth.
            </motion.p>
          ...
          >
            <div className="relative aspect-[5/4] overflow-hidden rounded-xl border border-black/5 bg-gradient-to-br from-white to-gray-50 shadow-xl">
              ...
              <div className="absolute bottom-3 left-3 flex items-center gap-2 rounded-xl bg-white/85 backdrop-blur px-3 py-2 text-sm shadow">
                <PiSteeringWheel className="text-[var(--color-primary)]" />{" "}
                Laser-calibrated equipment
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section id="problems" className="max-w-7xl mx-auto px-6 py-14">
        <div className="mb-6">
          ...
          <p className="text-gray-700 mt-2">
            Common symptoms and the exact alignment service that solves them.
          </p>
        </div>
              ...
              {[
                {
                  ...
                  d: "Set camber, toe, caster to OEM spec.",
                },
                {
                  t: "Steering wheel centering",
                  d: "Recalibrate and road‑test.",
                },
                {
                  t: "Tire wear correction",
                  d: "Adjust angles + rotate and balance.",
                },
                {
                  t: "Highway vibration check",
                  d: "Road force balance and toe correction.",
                },
                {
                  t: "Impact inspection",
                  d: "Measure, adjust, and replace bent parts if needed.",
                },
                {
                  t: "Custom fitment",
        ...
        <div className="rounded-3xl border border-black/5 bg-white/80 backdrop-blur p-6 shadow-xl">
          ...
          >
            {[
              {
                icon: <FiMapPin />,
                t: "Arrival & inspection",
                d: "We check suspension and tires first.",
              },
              {
                icon: <GiCarWheel />,
                t: "Mount & measure",
                d: "Laser heads on all four wheels.",
              },
              {
                icon: <PiSteeringWheel />,
                t: "Precision adjust",
                d: "Camber, caster, toe to spec.",
              },
              {
                icon: <FiCheckCircle />,
                t: "Road test",
                d: "Steering wheel straight, printout provided.",
              },
            ].map((s, i) => (
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            <div className="lg:col-span-2">
              ...
              <p className="mt-1 text-white/80">
                Pick a time that works. Most alignments take under 60 minutes.
              </p>

              <button
                type="submit"
                className="w-max rounded-xl border border-white/10 bg-white/10 px-6 py-3 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white flex items-center my-5 cursor-pointer"
              >
                Book an appointment
              ...
              <div className="rounded-xl bg-white/70 text-black p-5 shadow-2xl ring-1 ring-black/5">
                ...
                <ul className="mt-2 space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    {" "}
                    <FiCheckCircle className="text-green-600" /> 4‑wheel laser
                    alignment
                  </li>
                  <li className="flex items-center gap-2">
                    {" "}
                    <FiCheckCircle className="text-green-600" /> Steering wheel
                    centering
                  </li>
                  <li className="flex items-center gap-2">
                    {" "}
                    <FiCheckCircle className="text-green-600" /> Before/after
                    printout
                  </li>
                  <li className="flex items-center gap-2">
                    {" "}
                    <FiCheckCircle className="text-green-600" /> 12‑month
                    guarantee
                  </li>
                </ul>
                <div className="mt-4 rounded-xl bg-white/40 p-4">
                  <p className="text-3xl font-extrabold">
                    $<span className="tabular-nums">109</span>
                    <span className="text-base align-top"> CAD</span>
                  </p>
                  <p className="text-xs text-gray-600">
                    Price before tax. Most cars; SUVs/trucks may vary.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="rounded-3xl border border-black/5 bg-white/80 backdrop-blur p-6 shadow-xl">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
            <Faq
              ...
              a="Yes. New tires should start life at proper angles to avoid early wear and protect your warranty."
            />
            <Faq
              q="How long does it take?"
              a="Most alignments are done in under an hour, including road test and printout."
            />
            <Faq
              q="Can you align lowered cars?"
              a="Absolutely. We set custom specs for lowered, lifted, and track setups."
            />
            <Faq
              q="What if parts are bent?"
              a="We’ll show you the measurements and quote any suspension parts before proceeding."
            />
          </div>
        </div>
      </section>
