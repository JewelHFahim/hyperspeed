  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="relative overflow-hidden bg-gray-100">
        <div className="max-w-7xl mx-auto px-6 pt-16 pb-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            >
              From daily drivers to staggered fitments—our techs use protected
              clamps, torque to spec, and dynamic or road‑force balance for
              glass‑smooth cruising.
            </motion.p>
            ...
            >
              {[
                ...
                >
                  <span className="grid h-9 w-9 place-items-center rounded-lg bg-[var(--color-primary)]/10 text-[var(--color-primary)]">
                    {f.icon}
                  </span>
          ...
          >
            <div className="relative aspect-[5/4] overflow-hidden rounded-xl border border-black/5 bg-gradient-to-br from-white to-gray-50 shadow-xl">
              ...
              <div className="absolute bottom-3 left-3 flex items-center gap-2 rounded-xl bg-white/85 backdrop-blur px-3 py-2 text-sm shadow">
                <GiCarWheel className="text-[var(--color-primary)]" /> Dynamic &
      ...
      <section className="max-w-7xl mx-auto px-6 py-14">
        <div className="mb-6">
          <h2 className="text-3xl md:text-4xl font-bold">
            What’s wrong vs how we fix it
          </h2>
          <p className="text-gray-700 mt-2">
            Common symptoms and the exact service that solves them.
          </p>
        </div>
          ...
          >
            ...
            <ul className="mt-4 space-y-3">
              {[
                {
                  t: "Dynamic balancing",
                  d: "Corrects imbalance on both axes for smooth highway ride.",
                },
                {
                  t: "Road‑force match mounting",
                  d: "Measures tire/wheel forces and aligns the high/low spots for minimal vibration.",
                },
                {
                  t: "Bead seating & hub cleaning",
                  d: "Remove corrosion, apply proper lube, seat evenly, and prevent run‑out.",
                },
                {
                  t: "TPMS reset & valve service",
                  d: "Relearn sensors and replace valve cores/seals as needed.",
                },
                {
                  t: "Torque to spec",
                  d: "Hand torque with calibrated wrenches to OEM spec.",
                },
              ].map((s, i) => (
                <li key={i} className="flex items-start gap-3">
      ...
      <section className="max-w-7xl mx-auto px-6 py-8">
        <div className="rounded-xl border border-black/5 bg-white/80 backdrop-blur p-6 shadow-xl">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                price: "$119",
                features: [
                  "Road‑force measurement (4)",
                  "Match‑mount optimization",
                  "Adhesive/clip weights as needed",
                ],
                badge: "Most Popular",
              },
              {
                ...
                price: "$159",
                features: [
                  "Low‑profile/run‑flat care",
                  "Staggered fitments",
                  "TPMS relearn & road test",
                ],
              },
            ].map((p, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`relative rounded-2xl border border-black/5 bg-white p-5 shadow-sm ${p.badge && "border-green-300"}`}
              >
                {p.badge && (
                  <span className="absolute right-3 top-3 rounded-lg bg-green-500 text-white px-3 py-1 text-xs">
                    {p.badge}
                  </span>
                )}
                <h3 className="text-lg font-semibold">{p.name}</h3>
                <p className="mt-1 text-2xl font-extrabold">
                  {p.price} <span className="text-sm">CAD</span>
                </p>
                ...
                <a
                  href="#appointment"
                  className="mt-4 inline-flex items-center gap-2 rounded-lg bg-black text-white px-4 py-2"
                >
          ...
          <p className="mt-3 text-xs text-gray-600">
            Prices before tax. Run‑flats, oversized wheels, or seized hardware
            ...
            {[
              {
                icon: <GiCarWheel />,
                t: "Inspect & prep",
                d: "Check wheels/tires, TPMS, and clean hub faces.",
              },
              {
                icon: <PiSteeringWheel />,
                t: "Mount",
                d: "Lube beads, protect finish, seat evenly.",
              },
              {
                icon: <FiTool />,
                t: "Balance",
                d: "Dynamic or road‑force, add precise weights.",
              },
              {
                icon: <FiCheckCircle />,
                t: "Torque & test",
                d: "Hand torque to spec and road test.",
              },
            ].map((s, i) => (
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            <div className="lg:col-span-2">
              ...
              <p className="mt-1 text-white/80">
                Most sets completed within 45–60 minutes. Torque recheck
                recommended after 100 km.
              </p>
              ...
              <div className="rounded-xl bg-white/70 text-black p-5 shadow-2xl ring-1 ring-black/5">
                ...
                <ul className="mt-2 space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <FiCheckCircle className="text-green-600" /> Mount & balance
                    (4)
                  </li>
                  <li className="flex items-center gap-2">
                    <FiCheckCircle className="text-green-600" /> Adhesive or
                    clip‑on weights
                  </li>
                  <li className="flex items-center gap-2">
                    <FiCheckCircle className="text-green-600" /> TPMS reset (if
                    needed)
                  </li>
                  <li className="flex items-center gap-2">
                    <FiCheckCircle className="text-green-600" /> Torque to spec
                  </li>
                </ul>
                <div className="mt-4 rounded-xl bg-white/40 p-4">
                  ...
                  <p className="text-xs text-gray-600">
                    Price before tax. Run‑flats/oversize may vary.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-14">
        ...
        >
          ...
          <div className="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { n: "↓", l: "steering vibration", color: "bg-orange-50", text: "text-orange-500" },
              { n: "↓", l: "tire noise", color: "bg-blue-50",text: "text-blue-500" },
              { n: "↑", l: "high‑speed stability", color: "bg-cyan-50", text: "text-cyan-500" },
              { n: "✓", l: "butter‑smooth ride", color: "bg-green-50", text: "text-green-500" },
            ].map((s, i) => (
              <Stat key={i} n={s.n} l={s.l} m={s.color} text={s.text}/>
            ))}
          </div>
        </motion.div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
        <div className="rounded-3xl border border-black/5 bg-white/80 backdrop-blur p-6 shadow-xl">
          <h2 className="text-2xl md:text-3xl font-bold">
            Wheel Mount & Balance FAQ
          </h2>
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
            <Faq
              q="Do I need balancing with brand‑new tires?"
              a="Yes. New tires and wheels still require balancing to eliminate manufacturing tolerances."
            />
            <Faq
              q="What’s road‑force balancing?"
              a="A machine measures tire and wheel stiffness/force variation under load, then we rotate and match‑mount to minimize vibration."
            />
            <Faq
              q="How long does it take?"
              a="Most sets take 45–60 minutes. Complex fitments or TPMS issues can add time."
            />
            <Faq
              q="Should I re‑torque?"
              a="We recommend re‑torquing after ~100 km for safety—drop in for a quick, free check."
            />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-24">
        <div className="rounded-2xl border border-black/5 bg-white p-4 text-xs text-gray-600">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              Prices exclude tax and environmental fees. Aftermarket hardware or
              seized lugs may require additional labor.
            </li>
            <li>
              We use torque‑stick + hand torque to finish. Always re‑torque
              after 100 km.
            </li>
            <li>
              Extreme wheel sizes, bead damage, or bent rims may limit
              results—repairs/straightening quoted separately.
            </li>
          </ul>
        </div>
      </section>
...
function Stat({ n, l, m, text }) {
  return (
    <motion.div
      initial={{ opacity: 0, y: 12 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
      className={`rounded-xl border border-black/5 bg-whit e px-4 py-5 text-center shadow-sm ${m}`}
    >
      <div className={`text-3xl font-extrabold tracking-tight ${text}`}>{n}</div>
